...
CURRENT_DIR=$(pwd)
cd /home/sameer/Desktop/Edge_AI/Deployment_Examples/deployment_pipelines/cpu/raspberry_pi_5/ncnn
...
timeout $TIME_DURATION python yolo11_ncnn_inference1.py \
    ...
    --log-fps \
    --log-inference-fps \
    --csv-path /home/sameer/Desktop/Edge_AI/Deployment_Examples/deployment_pipelines/cpu/raspberry_pi_5/ncnn/yolo11_ncnn_metrics.csv \
